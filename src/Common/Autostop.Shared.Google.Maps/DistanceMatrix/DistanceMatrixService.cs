...
namespace Google.Maps.DistanceMatrix
{
    ...
    ///     destinations. The information returned is based on the recommended route
    ///     between start and end points, as calculated by the Google Maps API, and consists of rows containing duration and
    ///     distance values for each pair.
    ///     <para>
    ///         This service does not return detailed route information. Route information can be obtained by passing the
    ///         desired single origin and destination to the Directions API.
    ///     </para>
    /// </summary>
    /// <see href="http://developers.google.com/maps/documentation/distancematrix/" />
    public class DistanceMatrixService : IDisposable, IDistanceMatrixService
	{
